...
async function handleLoginSubmit(event) {
    ...
    //Para evidenciar el usuario y password ingresado
    ...
    if (response.ok) {
        ...
        //Para evidenciar token utilizado que permite acceder a los endpoints de mi API
        console.log('Login succesful:', data.token);
        
        setTimeout(() => {
            window.location.href = window.location.origin + '/pages/admin/EMILIO/cards/cards.html';
        }, 5000);
